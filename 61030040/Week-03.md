...
<li> ในกรณีที่ต้องการรักษา source code ของทั้งสองไฟล์ไว้ ควรทำอย่างไร
    <br>ตอบ กดแก้ Confict ก่อนทำการ merge และกด Keep code ไว้เพื่อเก็บรักษาโค้ด
          หรือทำการ Commit ก่อนหากเกิดข้อผิดพลาดก็ทำการ Undo ย้อนกลับไปยัง Commit ก่อนหน้า</br>
<li> ผลของการ keep target ออกมาเป็นอย่างไร
    <br>  ตอบ ทำให้ code ที่เราทำการ merge นั้นมีเหมือนเดิม </br>
<li> ผลของการ take source ออกมาเป็นอย่างไร
    <br>   ตอบ จะมีโค้ดเดิมอยู่และมีโค้ดเพิ่มเข้ามา </br>
<li> ให้ capture หน้าจอของ Compare files, Diff ที่ source, Diff ที่ target
    <br>  ตอบ </br>
</ol>		Compare file
  	 <img src = "./images/C-5M.JPG">
	 	Dift target
